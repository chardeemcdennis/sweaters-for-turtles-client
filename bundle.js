...
/***/ function(module, exports, __webpack_require__) {
	...
	var cartEvents = __webpack_require__(29);
	var orderEvents = __webpack_require__(33);
	var productEvents = __webpack_require__(37);
	var profileEvents = __webpack_require__(41);
	var stripeEvents = __webpack_require__(44);
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://sweaters-for-turtles.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var signedIn = __webpack_require__(8);
	var signedOut = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<button id=\"get-products\" class=\"btn btn-default\">Products</button>\n<button id=\"get-cart\" class=\"btn btn-default\">Cart</button>\n<button id=\"get-orders\" class=\"btn btn-default\">Orders</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id='content' class='content'>\n  <div class='row-fluid'>\n    <div class='col-md-10 how-sft-works'>\n      <h1>\n        Welcome to Sweaters for Turtles!\n      </h1>\n      <h2>\n          Sign in or sign up to buy sweaters to make your turtle look f#@king awesome.\n      </h2>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddToCart = function onAddToCart(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.addToCart(data).done(ui.addToCartSuccess).fail(ui.failure);
	};

	var onDisplayCart = function onDisplayCart(event) {
	  event.preventDefault();
	  api.displayCart().done(ui.displayCartSuccess).fail(ui.failure);
	};

	var onClearCart = function onClearCart(event) {
	  event.preventDefault();
	  api.clearCart().done(ui.clearCartSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayCart = __webpack_require__(32);
	...
	var cartTotalAmount = function cartTotalAmount(userCart) {
	  var runningTotal = 0;
	  userCart.forEach(function (element, index, array) {
	...
	var displayCartSuccess = function displayCartSuccess(user) {
	...
	var clearCartSuccess = function clearCartSuccess() {
	  $('#content').html("Your cart was emptied.");
	  app.user.cart = [];
	};

	var emptyCartSuccess = function emptyCartSuccess() {
	  $('#content').html("<h1>Your order was successful!</h1><br><h2>Enjoy your sweaters</h2>");
	  app.user.cart = [];
	};

	module.exports = {
	  displayCartSuccess: displayCartSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"col-md-6 product-in-cart\">\n      <h4 class='float-right'>Name: "
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h4>\n      <h4 class='float-right'>Price: $"
	    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
	    + "</h4>\n      <h4 class='float-right'>Quantity: "
	    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
	    + "</h4>\n      <br>\n      <img class='cart-image'\n           src=\"./assets/images/turtle-sweaters/"
	    + alias4(((helper = (helper = helpers.image || (depth0 != null ? depth0.image : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"image","hash":{},"data":data}) : helper)))
	    + "\"\n           alt=\"./assets/images/turtle-sweaters/taco.jpg\"\n           height=\"140\"\n           width=\"160\">\n      <!-- delete later -->\n    </div>\n\n";
	  ...
	  return "<div class=\"cart\">\n  <div class=\"checkout\">\n    <div class=\"totalAmount\">\n    <h3>Total Amount: $"
	    ...
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cart : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onDisplayOrders = function onDisplayOrders(event) {
	  event.preventDefault();
	  api.displayOrders().done(ui.displayOrdersSuccess).fail(ui.failure);
	};

	var onDeleteOrder = function onDeleteOrder(event) {
	  event.preventDefault();
	  var order_id = event.target.id;
	  api.deleteOrder(order_id).done(ui.deleteOrderSuccess).fail(ui.failure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onDisplayOrders: onDisplayOrders,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteOrder = function deleteOrder(order_id) {
	  var data = order_id;
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayOrders = __webpack_require__(36);

	var displayOrdersSuccess = function displayOrdersSuccess(orders) {
	  $('.hero').hide();
	  $('#content').html(displayOrders(orders));
	};

	var deleteOrderSuccess = function deleteOrderSuccess() {
	  $('#content').html("The order was deleted. Please re-open the order history.");
	};

	module.exports = {
	  displayOrdersSuccess: displayOrdersSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <div class=\"col-sm-6 show-order\">\n  <strong>Order Id:</strong>"
	    ...
	    + "\n  <br>\n  <button id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + " class=\"deleteOrder\">Delete This Order</button>\n</div>\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onDisplayProducts = function onDisplayProducts(event) {
	  event.preventDefault();
	  api.displayProducts().done(ui.displayProductsSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayProducts = __webpack_require__(40);

	var displayProductsSuccess = function displayProductsSuccess(products) {
	  $('.hero').hide();
	  $('#content').html(displayProducts(products));
	};

	module.exports = {
	  displayProductsSuccess: displayProductsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div id=div"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + " class=\"col-md-12 product\">\n  <img src=\"./assets/images/turtle-sweaters/"
	    + alias4(((helper = (helper = helpers.image || (depth0 != null ? depth0.image : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"image","hash":{},"data":data}) : helper)))
	    + "\"\n       alt=\"./assets/images/turtle-sweaters/taco.jpg\"\n       height=\"242\"\n       width=\"292\">\n  <h3 class=\"float-right name\">"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h3>\n  <!-- <p class=\"_id\">\n  "
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\n  </p> -->\n  <h4 class=\"float-right price\" id =\"price\">\n  $"
	    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
	    + "\n  </h4>\n  <div class=\"col-md-9 float-left\">\n    <h4>Description:</h4>\n    <p class=\"description\">\n    "
	    + alias4(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"description","hash":{},"data":data}) : helper)))
	    + "\n    </p>\n  </div>\n  <form class=\"add-to-cart\">\n    <fieldset>\n      <input class=\"input-number\" type=\"number\" name=\"quantity\" min=1\n             value=1>\n      <input type=\"text\" name=\"name\" style=\"display: none\"\n             value=\""
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	  ...
	  return "<h2> Our Wonderful Turtle Sweaters: </h2>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var ordersAPI = __webpack_require__(34);
	var cartAPI = __webpack_require__(30);
	var ui = __webpack_require__(45);
	var cartUi = __webpack_require__(31);
	...
	var stripeResponseHandler = function stripeResponseHandler(status, response) {
	  ...
	  if (response.error) {
	    ...
	    api.addStripeCharge(newOrder).done(ui.addStripeChargeSuccess, ordersAPI.createOrder(newOrder).done(ui.createOrderSuccess, cartAPI.clearCart).done(cartUi.emptyCartSuccess).fail(ui.createOrderFailure)).fail(ui.addStripeChargeFailure);
	  }
	};
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  addStripeChargeSuccess: addStripeChargeSuccess,
	  addStripeChargeFailure: addStripeChargeFailure
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "9d782036705e77601ed866bbb64572c5.jpg";
